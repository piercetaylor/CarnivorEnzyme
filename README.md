...
This FoldX × EVmutation quadrant analysis has not been applied to convergent substitutions in any plant system. It distinguishes substitutions whose fitness benefit is structural from those whose benefit is functional (e.g., altered substrate specificity or active-site geometry), and flags potential false positives where neither model supports a selective advantage.
